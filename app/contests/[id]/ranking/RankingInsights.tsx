                  ...
                  {!trend.revealed ? (
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-2 gap-3 sm:grid-cols-5">
                        ...
                        <div className="rounded-lg bg-xactscore-accent p-3"><span className="block text-[10px] font-black uppercase text-black">{labels.popularScore}</span><strong className="mt-1 block font-mono text-lg text-black">{trend.popularScore || '—'}</strong></div>
                      </div>
