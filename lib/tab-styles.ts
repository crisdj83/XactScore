...
export const tabActive =
  'border-transparent bg-transparent text-indigo-600 shadow-none backdrop-blur-md dark:border-xactscore-accent dark:bg-xactscore-accent dark:text-black'
...
export const segmentActive =
  'border-transparent bg-indigo-100 text-indigo-700 shadow-none backdrop-blur-md dark:border-xactscore-accent dark:bg-xactscore-accent dark:text-black'
